...
<html lang="en">
  ...
  <body>
  	<div class="container">
              ...
              <form class="form-inline" id="emp-SaveForm" action="#" >
                <div class="form-group">
                  <label for="name">Name</label>
                  <input type="text" class="form-control" id="name" name="emp_name" placeholder="Jane Doe">
                </div>
                <div class="form-group">
                  <label for="department">Department</label>
                  <input type="text" class="form-control" id="department" name="emp_dept" placeholder="Sales">
                </div>
                <div class="form-group">
                  <label for="salary">Department</label>
                  <input type="text" class="form-control" id="salary" name="emp_salary" placeholder="90000">
                </div>
